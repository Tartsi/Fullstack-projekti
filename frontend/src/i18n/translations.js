...
export const translations = {
    ...
    auth: {
      ...
      errors: {
        ...
        fullNameShort: "Nimen on oltava vähintään 4 kirjainta",
        emailRequired: "Sähköposti vaaditaan",
        emailInvalid: "Sähköpostiosoite on virheellinen",
        passwordRequired: "Salasana vaaditaan",
        passwordMinLength: "Salasanan tulee olla vähintään 6 merkkiä pitkä",
  ...
  en: {
    ...
    auth: {
      ...
      errors: {
        ...
        fullNameShort: "Full name must be atleast 4 characters long",
